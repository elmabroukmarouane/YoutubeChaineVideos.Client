        ...
        private async Task LoadData()
        {
            ...
            catch (Exception ex)
            {
                var log = LoggingMessaging.LoggingMessageError(
                    ...
                    actionName: "Components.Pages.YouTubeVideoCategory - LoadData()",
                    exception: ex
                );
            ...
            string titleOkButton = "Add")
        {
            ...
            catch (Exception ex)
            {
                var log = LoggingMessaging.LoggingMessageError(
                    ...
                    statusCodeInt: (int)HttpStatusCode.InternalServerError,
                    statusCode: HttpStatusCode.InternalServerError.ToString(),
                    actionName: "Components.Pages.YouTubeVideoCategory - ShowDialogAsync()",
                    exception: ex
                );
                await GenericLogService!.CreateAsync(BaseSettingsApp?.BaseUrlApiWebHttp + "Log", Token, new YouTubeApiAppLogViewModel()
                {
            ...
            string titleOkButton = "Delete")
        {
            ...
            catch (Exception ex)
            {
                var log = LoggingMessaging.LoggingMessageError(
                    ...
                    statusCodeInt: (int)HttpStatusCode.InternalServerError,
                    statusCode: HttpStatusCode.InternalServerError.ToString(),
                    actionName: "Components.Pages.YouTubeVideoCategory - ShowDeleteDialogAsync()",
                    exception: ex
                );
                await GenericLogService!.CreateAsync(BaseSettingsApp?.BaseUrlApiWebHttp + "Log", Token, new YouTubeApiAppLogViewModel()
                {
