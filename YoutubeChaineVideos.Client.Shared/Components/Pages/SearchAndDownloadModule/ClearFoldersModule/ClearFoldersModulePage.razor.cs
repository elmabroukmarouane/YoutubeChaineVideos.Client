...
namespace YoutubeChaineVideos.Client.Shared.Components.Pages.SearchAndDownloadModule.ClearFoldersModule
{
    public partial class ClearFoldersModulePage : ComponentBase
    {
        ...
        private async Task Ok()
        {
            ...
            var messageStatus = await VideoService!.ClearAndEmptyVideosAudiosOutputFolders($"{Uri}?clearOutput={ClearOutputFolder}", Token);
